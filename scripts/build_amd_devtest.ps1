...
try {
    ...
    & $taskPython -m PyInstaller --noconfirm packaging\AMD-DevTest.spec
    ...
    Copy-Item -LiteralPath (Join-Path $taskRoot 'docs\development\AMD_DEVTEST.md') -Destination $release -Force
