// Adapted from dashdogy/RTX40MFG-Unlock @ 33b41835dc39c5d8ab1ef93efb2449be31139c09.
// Copyright (c) 2026 Michael Robles. MIT; see LICENSE.txt in this directory.
...
bool PatchProvider(HMODULE module, const wchar_t* suppliedPath) noexcept
{
    ...
    if (!profile)
        return fail(Failure::eProviderVersion);
    const char* const outputSha256 = profile->outputFatbinSha256;
